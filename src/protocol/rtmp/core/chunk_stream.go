...
import (
	...
	"github.com/AdmiralBulldogTv/VodTransmuxer/src/utils/pool"
)
...
func (chunkStream *ChunkStream) writeHeader(w *ReadWriter) error {
	...
	case chunkStream.CSID-64 < 256:
		...
		err = w.WriteUintLE(chunkStream.CSID-64, 1)
		if err != nil {
			return err
		}
	case chunkStream.CSID-64 < 65536:
		...
		err = w.WriteUintLE(chunkStream.CSID-64, 2)
		if err != nil {
			return err
		}
	}
	...
	err = w.WriteUintBE(chunkStream.Length, 3)
	if err != nil {
		return err
	}
	err = w.WriteUintBE(chunkStream.TypeID, 1)
	if err != nil {
		return err
	}
	...
	err = w.WriteUintLE(chunkStream.StreamID, 4)
	if err != nil {
		return err
	}
END:
	//Extended Timestamp
	if ts >= 0xffffff {
		err = w.WriteUintBE(chunkStream.Timestamp, 4)
		if err != nil {
			return err
		}
	}

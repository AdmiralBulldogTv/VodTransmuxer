...
import (
	...
	"github.com/AdmiralBulldogTv/VodTransmuxer/src/health"
	"github.com/AdmiralBulldogTv/VodTransmuxer/src/monitoring"
	"github.com/AdmiralBulldogTv/VodTransmuxer/src/protocol"
	"github.com/AdmiralBulldogTv/VodTransmuxer/src/svc/mongo"
	"github.com/AdmiralBulldogTv/VodTransmuxer/src/svc/prometheus"
	"github.com/AdmiralBulldogTv/VodTransmuxer/src/svc/redis"
	"github.com/AdmiralBulldogTv/VodTransmuxer/src/svc/rmq"
...
func main() {
...

	{
		...
		rmqInst, err := rmq.New(ctx, rmq.SetupOptions{
			...
			QueueName: gCtx.Config().RMQ.TranscoderTaskQueue,
		})
		cancel()
		if err != nil {
	...
	dones := []<-chan struct{}{protocol.New(gCtx)}
